        ...
        <div style="background-color:#6C6187;width:100%;margin:0;padding:100px 0;top:0;position:relative;">
            <div style="width:70%;max-width:600px;margin:0 auto;background-color:#ffffff;">
                ...
                <div style="padding:30px;">
                    <h1 style="border-bottom:2px solid grey;padding-bottom:7px;">Nova registracija</h1>
                    Poštovani <strong>{{ $name }}</strong>,
                    <p>{{ $body }}</p>
                    <p>Na sledećem <a href="{{ url('/verify-email') }}"><strong>linku</strong></a> možete potvrditi Vašu email adresu.</p>
                    <br><br>
                    ---<br>
                    Srdačan pozdrav,
