...
$pdf->Output(__DIR__ . '/pdf/dpu-'.$file_n.'.pdf', 'F');
$pdf->Output('dpu-'. $file_n.'.pdf', 'D');
...
$mail->AddAttachment(__DIR__ . '/pdf/dpu-'.$file_n.'.pdf');      
// attach pdf that was saved in a folder
$mail->Subject = "Faktura " . $file_n;                  
$mail->Body = "Poštovani, u prilogu je Vaš LIST DNEVNOG PROMETA UGOSTITELJA.";
if(!$mail->Send())
{
