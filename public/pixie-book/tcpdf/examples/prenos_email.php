...
$pdf = new TCPDF('landscape', 'mm', 'A4', true, 'UTF-8', false);
...
$pdf->Output(__DIR__ . '/pdf/prenos-'.$file_n.'.pdf', 'F');
$pdf->Output('prenos-'. $file_n.'.pdf', 'D');
