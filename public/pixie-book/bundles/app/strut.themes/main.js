...
function(BackgroundProvider, Backgrounds, Surfaces, StylesheetProvider, ClassEditor) {
	...
	var slideBgProviderFactory = {
		create: function(editorModel) {
			return new BackgroundProvider({
				...
				selector: '.operatingTable .slideContainer .themedArea.krle-first',
				attr: 'Background',
	...
	// var slideBgProviderFactoryRight = {
	// 	create: function(editorModel) {
	// 		return new BackgroundProvider({
	// 			backgrounds: Backgrounds,
	// 			editorModel: editorModel,
	// 			selector: '.operatingTable .slideContainer .themedArea.krle-second',
	// 			attr: 'Background',
	// 			template: JST['strut.themes/BackgroundChooserDropdownRight']
	// 		});
	// 	}
	// };
