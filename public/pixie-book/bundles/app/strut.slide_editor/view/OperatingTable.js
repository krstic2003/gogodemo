...
function(Backbone, empty, ComponentFactory, GlobalEvents, Component,
	...
	return Backbone.View.extend({
		...
		render: function() {
			...
			//this._$markdownContenta = $('<div class="markdownArea themedArea krle-second"></div>');
			this._$slideContainer.append(this._$markdownContent);
			//this._$slideContainer.append(this._$markdownContenta);
		...
		_updateBg: function(model, bg) {
			...
			this._$slideContainer.addClass('slideContainer ui-selectable xss');
			DeckUtils.applyBackground(this._$markdownContent, this.model, this._deck, {transparentForSurface: true, surfaceForDefault: true});
		},

		// _updateBgRight: function(model, bg) {
		// 	if (!this._$slideContainer) return;
		// 	this._$slideContainer.removeClass();
		// 	this._$slideContainer.addClass('slideContainer ui-selectable xss');
		// 	DeckUtils.applyBackgroundRight(this._$markdownContenta, this.model, this._deck, {transparentForSurface: true, surfaceForDefault: true});
		// },
